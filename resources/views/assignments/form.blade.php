                        ...
                        <div class="col-xl-12">
                            <div class="card ">
                                ...
                                <div class="card-body p-3 pt-0">
                                    <input hidden type="text" name="id" value="{{ $assignment->id ?? '' }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 fv-row mb-5">
                                            ...
                                            <select name="student_id[]"
                                                class="form-select form-select-solid @error('student_id') is-invalid @enderror"
                                                data-control="select2" multiple size="4">
                                                <option disabled>Select Students</option>
                                                @foreach ($userslist as $user)
                                                    <option value="{{ $student_id = $user->id }}">{{ $user->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            @error('student_id')
                                        ...
                                        <select name="questionlist[]"
                                            class="form-select form-select-solid @error('questionlist') is-invalid @enderror"
                                            data-control="select2" multiple size="4">
                                        ...
                                        <!--begin::Col-->
                                        <input hidden name="teacher_id" id="inputTeacherId"
                                            class="form-select form-select-solid" value="{{ Auth::id() }}">
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <input hidden name="status" id="inputStatus" class="form-select form-select-solid"
                                            value="Not Completed">
                                        <!--end::Col-->
                                    </div>
                                    <!--begin::Submit-->
