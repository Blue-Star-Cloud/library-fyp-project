                                                    ...
                                                    <div class="d-flex align-items-center flex-wrap d-grid gap-2">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="m-0">
                                                                ...
                                                                <span
                                                                    class="fw-bold text-gray-800 fs-7">{{ (int) $book->review_avg_rating }}/5</span>
                                                            </div>
                                                            <!--end::Info-->
                                                        </div>
                                                        <!--end::Item-->
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <!--begin::Info-->
                                                            <div class="m-0">
                                                                <span class="fw-semibold text-gray-500 d-block fs-8">OR
                                                                    levels </span>
                                                                <span
                                                                    class="fw-bold text-gray-800 fs-7">{{ (int) $book->or_level }}</span>
                                                            </div>
                                                            <!--end::Info-->
                                                        </div>
                                                        <!--end::Item-->
                                                ...
                                                <div class="mb-6">
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <div
                                                            ...
                                                            <span
                                                                class="fs-6 text-gray-700 fw-bold">{{ $book->genres ? $book->genres->pluck('genre_name')->implode(', ') : 'N/A' }}</span>
                                                            <!--end::Date-->
                                                            <!--begin::Label-->
                                                        ...
                                                        <div
                                                            ...
                                                            <span class="fs-6 text-gray-700 fw-bold">
                                                                <span class="ms-n1" data-kt-countup="true"
                                                                    data-kt-countup-value="{{ $book->review_count ?? 0 }}">0</span></span>
                                                            <!--end::Number-->
                                                            <!--begin::Label-->
