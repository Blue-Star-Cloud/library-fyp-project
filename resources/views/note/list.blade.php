        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="d-flex flex-stack w-100">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Student Reports</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            <a href={{ route('notes') }} class="text-muted text-hover-primary">Student Reports</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <a href={{ route('nform') }} class="btn btn-sm fw-bold btn-success" data-bs-toggle="modal"
                                        ...
                                        @foreach ($noteslist as $note)
                                            <tr>
                                                <td class="align-middle ps-3">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="d-flex justify-content-start flex-column">
                                                            <div class="text-dark fw-bold d-block">{{ $note['title'] }}
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="align-middle text-end pe-3">
                                                    <a
                                                        href="{{ route('editnote', ['id' => $note['id']]) }}"class="btn btn-light-primary btn-icon h-35px w-35px">
                                                        <i class="fa-duotone fa-pen fs-4  h-35px w-35px align-items-center justify-content-center"
                                                            title="Edit" data-bs-toggle="tooltip"
                                                            data-bs-placement="top"></i></a>
                                                    <a href="{{ route('deletenote', ['id' => $note['id']]) }}" button
