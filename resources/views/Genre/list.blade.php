        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="d-flex flex-stack w-100">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <!--begin:: Add New-->
                    <a href={{ route('genreform') }} class="btn btn-sm fw-bold btn-success" data-bs-toggle="modal"
                        data-bs-target={{ route('genreform') }}><i class="fa-solid fa-plus me-1 fs-4"></i>Add New</a>
                    <!--end::Primary button-->
                                            ...
                                            <td class="align-middle ps-3">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="d-flex justify-content-start flex-column">
                                                        <div class="text-dark fw-bold d-block">{{ $genre['id'] }}</div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="align-middle">
                                                <div class="text-dark fw-bold d-block">{{ $genre['genre_name'] }}</div>
                                            </td>

                                            <td class="align-middle text-end pe-3">
                                                <a
                                                    href="{{ route('editgenre', ['id' => $genre['id']]) }}"class="btn btn-light-primary btn-icon h-35px w-35px">
                                                    <i class="fa-duotone fa-pen fs-4  h-35px w-35px align-items-center justify-content-center"
                                                        title="Edit" data-bs-toggle="tooltip"
                                                        data-bs-placement="top"></i></a>
                                                <a href="{{ route('deletegenre', ['id' => $genre['id']]) }}" button
