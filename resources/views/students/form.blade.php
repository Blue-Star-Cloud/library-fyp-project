                                    ...
                                    <div class="card-body p-3 pt-0">
                                        <div class="row">
                                            ...
                                            @if (empty($user))
                                                ...
                                                <div class="col-md-6 fv-row mb-5">
                                                    ...
                                                    @error('password')
                                                        ...
                                                        <span class="invalid-feedback" role="alert">
                                                            The password must have one uppercase letter, one number, a special
                                                            case character and must be minimum 8 letters length
                                                        </span>
                                                    @enderror
                                                </div>
                                            @endif
                                            ...
                                            <div class="col-md-6 fv-row mb-5">
                                                ...
                                                <select name="assigned_class" id="inputClass"
                                                    class="form-select form-select-solid @error('assigned_class') is-invalid @enderror">
                                                    <option value="" disabled selected>Select Class</option>
                                                    @foreach ($classes as $class)
                                                        <option value="{{ $class->id }}"
                                                            {{ ($user->class->id ?? '') == $class->id ? 'selected' : '' }}>
                                                            {{ $class->class_name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-6 fv-row mb-5">
                                                ...
                                                <input type="date" name="date_of_birth"
                                                    value="{{ $user->date_of_birth ?? '' }}" id="inputDateOfBirth"
