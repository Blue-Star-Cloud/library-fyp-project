...
@section('content')
    <div class="kt-app-main-content d-flex flex-column app-container container-fluid">
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="d-flex flex-stack w-100">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <!--begin:: Add New-->
                    <a href={{ route('form') }} class="btn btn-sm fw-bold btn-success" data-bs-toggle="modal"
                        data-bs-target={{ route('form') }}><i class="fa-solid fa-plus me-1 fs-4"></i>Add New</a>
                    <!--end::Primary button-->
                                        ...
                                        @if ($user->role == 'student')
                                            <tr>
                                                <td class="align-middle">
                                                    <div class="text-dark fw-bold d-block"> <input type="checkbox"
                                                            name="students[]" value="{{ $user->id }}"></div>
                                                </td>
                                                ...
                                                <td class="align-middle">
                                                    <div class="text-dark fw-bold">
                                                        {{ $user->class ? $user->class->class_name : 'N/A' }}</div>
                                                </td>
                                                <td class="align-middle">
                                                ...
                                                <td class="align-middle">
                                                    <div class="text-dark fw-bold">
                                                        {{ $user->book ? $user->book->title : 'N/A' }}</div>
                                                </td>
                                                ...
                                                <td class="align-middle text-end pe-3">
                                                    ...
                                                    <a href="{{ route('assign', ['id' => $user['id']]) }}"
                                                        class="btn btn-light-danger btn-icon h-35px w-35px"><i
                                                            class="fa-duotone fa-swatchbook fs-4 h-35px w-35px align-items-center justify-content-center"
                                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                                            title="Assign"></i>
                                                    </a>
                                                    <a href="{{ route('viewstudentnotes', ['id' => $user['id']]) }}"
                                                        class="btn btn-light-info btn-icon h-35px w-35px">
                                                        <i class="fa-duotone fa-note-sticky fs-4 h-35px w-35px align-items-center justify-content-center"
                                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                                            title="Notes"></i></a>

                                                    <a href="{{ route('edit', ['id' => $user['id']]) }}"
                                                        class="btn btn-light-primary btn-icon h-35px w-35px">
                                                        <i class="fa-duotone fa-pen fs-4  h-35px w-35px align-items-center justify-content-center"
                                                            title="Edit" data-bs-toggle="tooltip"
                                                            data-bs-placement="top"></i></a>

                                                    <a href="{{ route('delete', ['id' => $user['id']]) }}" button
                                                        type="button"
        ...
        <div class="modal fade" id="assignStudentsModalBook" tabindex="-1"
            aria-labelledby="assignStudentsModalBookLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#assignStudentsBtnBook').on('click', function() {
                    ...
                    $('#selectedStudentsBook').val(selectedStudents.join(
                    ',')); // Store student IDs in hidden input
