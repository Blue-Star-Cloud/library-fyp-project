        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="d-flex flex-stack w-100">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Form
                        Classes</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <a href={{ route('formclasscreation') }} class="btn btn-sm fw-bold btn-success" data-bs-toggle="modal"
                        data-bs-target={{ route('selectbook') }}><i class="fa-solid fa-plus me-1 fs-4"></i>Add New</a>
                    @endif
                    <!--end::Primary button-->
                </div>
                    ...
                    <div class="card-body p-5">
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="kt_datatable_both_scrolls" class="table table-row-bordered gy-5 gs-7 mb-0">
                                ...
                                <tbody>
                                    @if (empty($selectedid))
                                        @foreach ($formclasseslist as $formclass)
                                            <tr>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="d-flex justify-content-start flex-column">
                                                            <div class="text-dark fw-bold d-block">
                                                                {{ $formclass['class_name'] }}</div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="align-middle">
                                                    <div class="text-dark fw-bold d-block">
                                                        {{ $formclass->teacher ? $formclass->teacher->name : 'No Teacher Assigned' }}
                                                    </div>
                                                </td>
                                                @if (Auth::user()->role == 'admin')
                                                <td class="align-middle text-end pe-3">
                                                    
                                                    <a href="{{ route('editformclass', ['id' => $formclass['id']]) }}"
                                                    ...
                                                    <a href="{{ route('deleteformclass', ['id' => $formclass['id']]) }}" button
                                                        type="button" class=" btn btn-light-danger btn-icon h-35px w-35px"
